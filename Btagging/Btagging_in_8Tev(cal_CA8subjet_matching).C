...
void Btagging_in_8Tev()
{
	...
	//CA8 subjet
	int CA8subjet_around_1_b=0;
	int CA8subjet_around_2_b=0;
	int CA8subjet_around_1_nb=0;
	int CA8subjet_around_many_nb=0;
	int CA8subjet_around_ele_noj=0;
	int CA8subjet_around_mu_noj=0;

	int n_of_ev_with_0_CA8subjet_around_b=0;
	int n_of_ev_with_1_CA8subjet_around_b=0;
	int n_of_ev_with_2_CA8subjet_around_b=0;
	int n_of_ev_with_3_CA8subjet_around_b=0;
	int n_of_ev_with_4_CA8subjet_around_b=0;
	int n_of_ev_with_5_CA8subjet_around_b=0;


	int n_of_CA8_with_0_subjet=0;
	int n_of_CA8_with_1_subjet=0;
	int n_of_CA8_with_2_subjet=0;
	int n_of_CA8_with_3_subjet=0;
	int n_of_CA8_with_4_subjet=0;
	int n_of_CA8_with_5_subjet=0;
	int n_of_CA8_with_6_subjet=0;
	int n_of_CA8_with_7_subjet=0;
	int n_of_CA8_with_8_subjet=0;
	...
	// event loop : counting b-tagging
  	for (Long64_t Nth = 0; Nth < N_of_ev; Nth++)
		...
		vector<jet_cone> jet_cones_this_ev;
		float R=0.3;
		int n_of_CA8subjet_around_b=0;

      		for (int i=0;i<CA8nJet;i++)
        	{	
			total_n_of_CA8++;
			if(CA8subjetPrunedPt->size()==0){n_of_CA8_with_0_subjet++;}
			else if(CA8subjetPrunedPt->size()==1){n_of_CA8_with_1_subjet++;}
			else if(CA8subjetPrunedPt->size()==2){n_of_CA8_with_2_subjet++;}
			else if(CA8subjetPrunedPt->size()==3){n_of_CA8_with_3_subjet++;}
			else if(CA8subjetPrunedPt->size()==4){n_of_CA8_with_4_subjet++;}
			else if(CA8subjetPrunedPt->size()==5){n_of_CA8_with_5_subjet++;}
			else if(CA8subjetPrunedPt->size()==6){n_of_CA8_with_6_subjet++;}
			else if(CA8subjetPrunedPt->size()==7){n_of_CA8_with_7_subjet++;}
			else if(CA8subjetPrunedPt->size()==8){n_of_CA8_with_8_subjet++;}

			//cout<<"--"<<CA8subjetPrunedPt->size()<<"--"<<endl;
			for (int j=0;j<CA8subjetPrunedPt->size();j++)
			{

				CA8subjet this_j(CA8subjetPrunedPt[i][j],CA8subjetPrunedEta[i][j],CA8subjetPrunedPhi[i][j],CA8subjetPrunedEn[i][j],
					CA8subjetPrunedMass[i][j],CA8subjetPrunedCSV[i][j]);
				jet_cone this_jet_cone;

				for(int k=0;k<nGenPar;k++)
				{
					gen_par this_g = gen_par(genParPt[k], genParEta[k], genParPhi[k], genParE[k], genParM[k],
					genParId[k], genParIndex[k], genMomParId[k], genMo1[k], genMo2[k], genParSt[k]);
					if (delta_R(this_j,this_g)<=R)
					{
						int this_g_id=abs(this_g.id);
						if(this_g_id==5){this_jet_cone.gen_b++;}
				...
				if (this_jet_cone.gen_b>0){ n_of_CA8subjet_around_b++;}
				jet_cones_this_ev.push_back(this_jet_cone);
				

			}

		}
		if( n_of_CA8subjet_around_b==0){n_of_ev_with_0_CA8subjet_around_b++;}
		if( n_of_CA8subjet_around_b==1){n_of_ev_with_1_CA8subjet_around_b++;}
		if( n_of_CA8subjet_around_b==2){n_of_ev_with_2_CA8subjet_around_b++;}
		if( n_of_CA8subjet_around_b==3){n_of_ev_with_3_CA8subjet_around_b++;}
		if( n_of_CA8subjet_around_b==4){n_of_ev_with_4_CA8subjet_around_b++;}
		if( n_of_CA8subjet_around_b==5){n_of_ev_with_5_CA8subjet_around_b++;}

		
		for (int i=0;i<jet_cones_this_ev.size();i++)
		{
			cout<<endl<<"----rec jet:"<<i<<"----"<<endl;
			jet_cone this_jet_cone=jet_cones_this_ev[i];
			cout<<"around this CA8subjet R="<<R<<":"<<
			"gen_b="<<this_jet_cone.gen_b<<
			",gen_nb="<<this_jet_cone.gen_nb<<
			",ele="<<this_jet_cone.gen_ele<<
			",mu"<<this_jet_cone.gen_mu<<endl;

			if (this_jet_cone.gen_b==1){CA8subjet_around_1_b++; }
			if (this_jet_cone.gen_b==2){CA8subjet_around_2_b++; }
			if (this_jet_cone.gen_nb==1){CA8subjet_around_1_nb++;}
			if (this_jet_cone.gen_b>1){CA8subjet_around_many_nb++;}
			if (this_jet_cone.gen_ele>0 && this_jet_cone.gen_b==0 && this_jet_cone.gen_nb==0){CA8subjet_around_ele_noj++;}
			if (this_jet_cone.gen_mu>0 && this_jet_cone.gen_b==0 && this_jet_cone.gen_nb==0 ){CA8subjet_around_mu_noj++;}
	...
	cout<<"==========================================reprot========================================="<<endl;
	cout<<"CA8subjet_around_1_b:"<<CA8subjet_around_1_b<<endl;
	cout<<"CA8subjet_around_2_b:"<<CA8subjet_around_2_b<<endl;
	cout<<"CA8subjet_around_1_nb:"<<CA8subjet_around_1_nb<<endl;
	cout<<"CA8subjet_around_many_nb:"<<CA8subjet_around_many_nb<<endl;
	cout<<"CA8subjet_around_ele_noj:"<<CA8subjet_around_ele_noj<<endl;
	cout<<"CA8subjet_around_mu_noj:"<<CA8subjet_around_mu_noj<<endl;
	cout<<"n_of_ev_with_0_CA8subjet_around_b:"<<n_of_ev_with_0_CA8subjet_around_b<<endl;
	cout<<"n_of_ev_with_1_CA8subjet_around_b:"<<n_of_ev_with_1_CA8subjet_around_b<<endl;
	cout<<"n_of_ev_with_2_CA8subjet_around_b:"<<n_of_ev_with_2_CA8subjet_around_b<<endl;
	cout<<"n_of_ev_with_3_CA8subjet_around_b:"<<n_of_ev_with_3_CA8subjet_around_b<<endl;
	cout<<"n_of_ev_with_4_CA8subjet_around_b:"<<n_of_ev_with_4_CA8subjet_around_b<<endl;
	cout<<"n_of_ev_with_5_CA8subjet_around_b:"<<n_of_ev_with_5_CA8subjet_around_b<<endl;
	cout<<"n_of_CA8_with_0_subjet:"<<n_of_CA8_with_0_subjet<<endl;
	cout<<"n_of_CA8_with_1_subjet:"<<n_of_CA8_with_1_subjet<<endl;
	cout<<"n_of_CA8_with_2_subjet:"<<n_of_CA8_with_2_subjet<<endl;
	cout<<"n_of_CA8_with_3_subjet:"<<n_of_CA8_with_3_subjet<<endl;
	cout<<"n_of_CA8_with_4_subjet:"<<n_of_CA8_with_4_subjet<<endl;
	cout<<"n_of_CA8_with_5_subjet:"<<n_of_CA8_with_5_subjet<<endl;
	cout<<"n_of_CA8_with_6_subjet:"<<n_of_CA8_with_6_subjet<<endl;
	cout<<"n_of_CA8_with_7_subjet:"<<n_of_CA8_with_7_subjet<<endl;
	cout<<"n_of_CA8_with_8_subjet:"<<n_of_CA8_with_8_subjet<<endl;
	cout<<"total_n_of_CA8"<<total_n_of_CA8<<endl;
