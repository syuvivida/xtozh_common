...
class AK5dr8
{
	...
	int gen_ele;
	int gen_mu;
	AK5dr8(){ gen_b=0;gen_nb=0;gen_ele=0;gen_mu=0;}
...
void Btagging_in_8Tev()
{
	...
	int AK5_around_1_b=0;
	int AK5_around_2_b=0;
	int AK5_around_1_nb=0;
	int AK5_around_many_nb=0;
	int AK5_around_ele_noj=0;
	int AK5_around_mu_noj=0;

	int n_of_ev_with_0_AK5_around_b=0;
	int n_of_ev_with_1_AK5_around_b=0;
	int n_of_ev_with_2_AK5_around_b=0;
	int n_of_ev_with_3_AK5_around_b=0;
	...
	// event loop : counting b-tagging
  	for (Long64_t Nth = 0; Nth < N_of_ev; Nth++)
		...
		//AK5 match with genPar
		vector<AK5dr8> AK5dr8s_this_ev;
		float R=0.5;
		int n_of_AK5_around_b=0;

      		for (int i=0;i<AK5nJet;i++)
        	{	
			//cout<<endl<<"----rec jet:"<<i<<"----"<<endl;
			AK5jet this_j(AK5jetPt[i],AK5jetEta[i],AK5jetPhi[i],AK5jetEn[i],AK5jetMass[i],AK5jetCSV[i],
			...
			for(int j=0;j<nGenPar;j++)
			{
				...
				if (delta_R(this_j,this_g)<=R)
				{
					...
					if(this_g_id==5){this_AK5dr8.gen_b++;}
					if(this_g_id<=4 && this_g_id>=0){this_AK5dr8.gen_nb++;}
					if(this_g_id==11){this_AK5dr8.gen_ele++;}
					if(this_g_id==13){this_AK5dr8.gen_mu++;}				
				}	
			}
			if (this_AK5dr8.gen_b>0){ n_of_AK5_around_b++;}
			AK5dr8s_this_ev.push_back(this_AK5dr8);
		}
		if( n_of_AK5_around_b==0){n_of_ev_with_0_AK5_around_b++;}
		if( n_of_AK5_around_b==1){n_of_ev_with_1_AK5_around_b++;}
		if( n_of_AK5_around_b==2){n_of_ev_with_2_AK5_around_b++;}
		if( n_of_AK5_around_b==3){n_of_ev_with_3_AK5_around_b++;}
		
		
		for (int i=0;i<AK5dr8s_this_ev.size();i++)
		{
			cout<<endl<<"----rec jet:"<<i<<"----"<<endl;
			AK5dr8 this_AK5dr8=AK5dr8s_this_ev[i];
			cout<<"around this AK5 R="<<R<<":"<<
			"gen_b="<<this_AK5dr8.gen_b<<
			",gen_nb="<<this_AK5dr8.gen_nb<<
			",ele="<<this_AK5dr8.gen_ele<<
			",mu"<<this_AK5dr8.gen_mu<<endl;

			if (this_AK5dr8.gen_b==1){AK5_around_1_b++; }
			if (this_AK5dr8.gen_b==2){AK5_around_2_b++; }
			if (this_AK5dr8.gen_nb==1){AK5_around_1_nb++;}
			if (this_AK5dr8.gen_b>1){AK5_around_many_nb++;}
			if (this_AK5dr8.gen_ele>0 && this_AK5dr8.gen_b==0 && this_AK5dr8.gen_nb==0){AK5_around_ele_noj++;}
			if (this_AK5dr8.gen_mu>0 && this_AK5dr8.gen_b==0 && this_AK5dr8.gen_nb==0 ){AK5_around_mu_noj++;}
	...
	cout<<"==========================================reprot========================================="<<endl;
	cout<<"AK5_around_1_b:"<<AK5_around_1_b<<endl;
	cout<<"AK5_around_2_b:"<<AK5_around_2_b<<endl;
	cout<<"AK5_around_1_nb:"<<AK5_around_1_nb<<endl;
	cout<<"AK5_around_many_nb:"<<AK5_around_many_nb<<endl;
	cout<<"AK5_around_ele_noj:"<<AK5_around_ele_noj<<endl;
	cout<<"AK5_around_mu_noj:"<<AK5_around_mu_noj<<endl;
	cout<<"n_of_ev_with_0_AK5_around_b:"<<n_of_ev_with_0_AK5_around_b<<endl;
	cout<<"n_of_ev_with_1_AK5_around_b:"<<n_of_ev_with_1_AK5_around_b<<endl;
	cout<<"n_of_ev_with_2_AK5_around_b:"<<n_of_ev_with_2_AK5_around_b<<endl;
	cout<<"n_of_ev_with_3_AK5_around_b:"<<n_of_ev_with_3_AK5_around_b<<endl;
