...
GH = Parameter(name = 'GH',
               nature = 'internal',
               type = 'real',
               value =  '-(1.45*aS/(4*cmath.pi*v))*(FmeioH)',
               texname = 'G_H')
...
MH2 = Parameter(name = 'MH2',
                nature = 'internal',
                type = 'real',
                value = 'cmath.sqrt(lam*v**2 + rho*xi**2 + cmath.sqrt(kap**2*v**2*xi**2 + (lam*v**2 - rho*xi**2)**2))',
                texname = '\\text{MH2}')

muH2 = Parameter(name = 'muH2',
                 nature = 'internal',
                 type = 'real',
                 value = '(kap*v**2 + lam*xi**2)/2.',
                 texname = '\\text{muH2}')
...
th = Parameter(name = 'th',
               nature = 'internal',
               type = 'real',
               value = 'cmath.atan((kap*v*xi)/(-(lam*v**2) + rho*xi**2))/2.',
               texname = '\\text{th}')
