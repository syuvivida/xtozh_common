...
GC_13 = Coupling(name = 'GC_13',
                 value = '-6*ch**3*complex(0,1)*kap*sh + 24*ch**3*complex(0,1)*rho*sh + 6*ch*complex(0,1)*kap*sh**3 - 6*ch*complex(0,1)*lam*sh**3',
                 order = {'QED':2})

GC_14 = Coupling(name = 'GC_14',
                 value = '6*ch**3*complex(0,1)*kap*sh - 6*ch**3*complex(0,1)*lam*sh - 6*ch*complex(0,1)*kap*sh**3 + 24*ch*complex(0,1)*rho*sh**3',
                 order = {'QED':2})

GC_15 = Coupling(name = 'GC_15',
                 value = '-2*ch**4*complex(0,1)*kap + 8*ch**2*complex(0,1)*kap*sh**2 - 6*ch**2*complex(0,1)*lam*sh**2 - 24*ch**2*complex(0,1)*rho*sh**2 - 2*complex(0,1)*kap*sh**4',
                 order = {'QED':2})

GC_16 = Coupling(name = 'GC_16',
                 value = '-24*ch**4*complex(0,1)*rho - 12*ch**2*complex(0,1)*kap*sh**2 - 6*complex(0,1)*lam*sh**4',
                 order = {'QED':2})

GC_17 = Coupling(name = 'GC_17',
                 value = '-6*ch**4*complex(0,1)*lam - 12*ch**2*complex(0,1)*kap*sh**2 - 24*complex(0,1)*rho*sh**4',
                 order = {'QED':2})
...
GC_57 = Coupling(name = 'GC_57',
                 value = '-6*ch**2*complex(0,1)*kap*sh*v - 6*complex(0,1)*lam*sh**3*v - 12*ch**3*complex(0,1)*rho*xi*cmath.sqrt(2) - 3*ch*complex(0,1)*kap*sh**2*xi*cmath.sqrt(2)',
                 order = {'QED':1})

GC_58 = Coupling(name = 'GC_58',
                 value = '4*ch**2*complex(0,1)*kap*sh*v - 6*ch**2*complex(0,1)*lam*sh*v - 2*complex(0,1)*kap*sh**3*v - ch**3*complex(0,1)*kap*xi*cmath.sqrt(2) + 2*ch*complex(0,1)*kap*sh**2*xi*cmath.sqrt(2) - 12*ch*complex(0,1)*rho*sh**2*xi*cmath.sqrt(2)',
                 order = {'QED':1})

GC_59 = Coupling(name = 'GC_59',
                 value = '-2*ch**3*complex(0,1)*kap*v + 4*ch*complex(0,1)*kap*sh**2*v - 6*ch*complex(0,1)*lam*sh**2*v - 2*ch**2*complex(0,1)*kap*sh*xi*cmath.sqrt(2) + 12*ch**2*complex(0,1)*rho*sh*xi*cmath.sqrt(2) + complex(0,1)*kap*sh**3*xi*cmath.sqrt(2)',
                 order = {'QED':1})

#GC_60 = Coupling(name = 'GC_60',
#                 value = '-6*ch**3*complex(0,1)*lam*v - 6*ch*complex(0,1)*kap*sh**2*v + 3*ch**2*complex(0,1)*kap*sh*xi*cmath.sqrt(2) + 12*complex(0,1)*rho*sh**3*xi*cmath.sqrt(2)',
#                 order = {'QED':1})
