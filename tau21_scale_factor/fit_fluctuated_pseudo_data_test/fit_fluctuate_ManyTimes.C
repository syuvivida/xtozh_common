...
#include "fit_chi2_err_three_components.C"
#include "TStyle.h"
#include "TSystem.h"
#include "TRandom.h"
#include "TCanvas.h"

void fit_fluctuate_ManyTimes(){

//

int N_times = 1;//1000

//double lower_SigFrc = 0.488; double upper_SigFrc = 0.500;
//int N_bins_SigFrc =96;
...
//double lower_Pull2 = -0.005; double upper_Pull2 = 0.015;
//int N_bins_Pull2 =160;

double lower_Pull2 = -1; double upper_Pull2 = 1;
...
//double lower_Pull1 = 0.488; double upper_Pull1 = 0.500;
//int N_bins_Pull1 =160;

//double lower_Pull2 = -0.005; double upper_Pull2 = 0.015;
//int N_bins_Pull2 =160;

////
//  TH1F *h_Distri_SigFrc = new TH1F("distribution of signal fraction","",80,0.46,0.54);
//  TH1F *h_Distri_SigFrc = new TH1F("distribution of signal fraction","",60,0.48,0.50);
//  TH1F *h_Distri_SigFrc = new TH1F("distribution of signal fraction","",80,0.48,0.50);
...
//  TH1F *h_Distri_Pull2 = new TH1F("distribution of signal fraction","",100,-0.5,0.5);
//  TH1F *h_Distri_Pull2 = new TH1F("distribution of signal fraction","",120,-0.015,0.015);
  TH1F *h_Distri_Pull2 = new TH1F("distribution of pull2 fraction","" ,N_bins_Pull2,lower_Pull2,upper_Pull2);
  TH1F *h_Distri_Pull1 = new TH1F("distribution of pull1 fraction","" ,N_bins_Pull1,lower_Pull1,upper_Pull1);
///

int NumberOfEventOfData = 982;//982 

double fraction_1= 0.49;//0.49
double fraction_2= 0.39;//0.39
...
//   if ( ev % 5000 == 0 )     fprintf(stderr, "Processing event %lli of %lli\n", i + 1, N_times);
...
double sigFrac_intial = 0.48;//n_Sig/n_data ;//n_Sig/n_data ;// 0.48
double bkg1Frac_intial = 0.4;//n_Bk1/n_data ;// 0.4


   double sig, sigerr,bkgfrc1,bkgfrcerr1,chi2;

fit_chi2_err_three_components(  h_data_new,
                                h_Signal,
                                h_Background1,
                                h_Background2,
                                "name",
...
cout<< "fraction 3 should be: "<< fraction_3 <<endl;
      cout<<"***********************************************************" <<endl;
...
TCanvas * c2 =new TCanvas("c2","pull2",600,600);
h_Distri_Pull2->Draw();
...
TCanvas * c4 =new TCanvas("c4","pull1",600,600);
//h_Distri_Pull1->Draw();
