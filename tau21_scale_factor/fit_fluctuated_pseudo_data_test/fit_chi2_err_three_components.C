...
// -- main function
void fit_chi2_err_three_components(TH1F* dataInput, TH1F* sigTemplate, TH1F* bkgTemplate1, TH1F* bkgTemplate2, std::string prefix, 
...
//  htmp2->SetXTitle("SigmaIetaIeta");
  htmp2->SetXTitle("mass of hadronic decay top");
  htmp2->SetYTitle("A.U.");
...
//cout<< "dataInput entry: "<< dataInput ->GetEntries() <<endl;
//cout<< "fit_result entry: "<< fit_result ->GetEntries() <<endl;
//fit_result->ResetStats();
//cout<< "fit_result entry: "<< fit_result ->GetEntries() <<endl;
//cout<< "data  entry: "<< data ->GetEntries() <<endl;
//cout<< "signal_display  entry: "<< signal_display  ->GetEntries() <<endl;
//cout<< "background_display1 entry: "<<background_display1  ->GetEntries() <<endl;
//cout<< "background_display2 entry: "<<background_display2  ->GetEntries() <<endl;
