...
void fit_fluctuate_ManyTimes_with_tau_and_Wbb(){

//

int N_times = 5000;//1000
...
TH1F *h_Bk2 = (TH1F*)f2->Get("h_had_top_mass_bk2");
...
// clone, Sumw2 and normalize
   ...
   TH1F *h_Background2 = (TH1F*)h_Bk2 ->Clone();
...
scale = 1.0/( h_Background2->Integral() );
h_Background2->Scale(scale);
...
// the estimated number of event in 19.7 fb^-1 luminosity

double NumberOfTTbarSig = 558.7; //already add tau channel
double NumberOfTTbarBk1 = 423.2; //already add tau channel 
double NumberOfWbb = 42.3;// Wbb bk2 shape

//double NumberOfEventOfData = 1024;//1024  
double NumberOfEventOfData = NumberOfTTbarSig + NumberOfTTbarBk1 + NumberOfWbb;

double fraction_1= NumberOfTTbarSig / NumberOfEventOfData ;//0.544
double fraction_2= NumberOfTTbarBk1 / NumberOfEventOfData ;//0.431
double fraction_3= 1 - fraction_1 -fraction_2 ;// 0.041
// Data = fraction_1*Sig + fraction_2*Bk1 + fraction_3*Bk2

//double NumberOfEventOfData = 1024;//1024  
//double fraction_1= 0.544 ;//0.544
//double fraction_2= 0.431 ;//0.431
//double fraction_3= 1 - fraction_1 -fraction_2 ;// 0.041
...
char name[200]={"3_components_of_ttbar_sig_bkg1_and_Wbb_bkg2_fit"};
