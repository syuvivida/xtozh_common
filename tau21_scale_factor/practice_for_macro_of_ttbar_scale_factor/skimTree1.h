...
//   TBranch        *b_CA8subjetMotherIndex;   //!
   ...
   skimTree1(std::string inputFile,TTree *tree=0);
   virtual ~skimTree1();
...
Int_t skimTree1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t skimTree1::LoadTree(Long64_t entry)
{
...
void skimTree1::Init(TTree *tree)
{
...
void skimTree1::Show(Long64_t entry)
{
