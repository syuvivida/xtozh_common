...
// Mon Oct  6 22:20:30 2014 by ROOT version 5.34/21
// from TTree tree/tree
// found on file: flattuple_12_1_pNo.root
//////////////////////////////////////////////////////////

#ifndef makeclass_of_flattuple_12_1_pNo_h
#define makeclass_of_flattuple_12_1_pNo_h
...
#include "/Users/bellenot/source/root_v5.34.21/root/cint/cint/lib/prec_stl/vector"
#include "/Users/bellenot/source/root_v5.34.21/root/cint/cint/lib/prec_stl/vector"
#include "/Users/bellenot/source/root_v5.34.21/root/cint/cint/lib/prec_stl/vector"

// Fixed size dimensions of array or collections stored in the TTree if any.

class makeclass_of_flattuple_12_1_pNo {
public :
   ...
   makeclass_of_flattuple_12_1_pNo(TTree *tree=0);
   virtual ~makeclass_of_flattuple_12_1_pNo();
...
#ifdef makeclass_of_flattuple_12_1_pNo_cxx
makeclass_of_flattuple_12_1_pNo::makeclass_of_flattuple_12_1_pNo(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("flattuple_12_1_pNo.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("flattuple_12_1_pNo.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("flattuple_12_1_pNo.root:/tree");
...
makeclass_of_flattuple_12_1_pNo::~makeclass_of_flattuple_12_1_pNo()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t makeclass_of_flattuple_12_1_pNo::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t makeclass_of_flattuple_12_1_pNo::LoadTree(Long64_t entry)
{
...
void makeclass_of_flattuple_12_1_pNo::Init(TTree *tree)
{
...
Bool_t makeclass_of_flattuple_12_1_pNo::Notify()
{
...
void makeclass_of_flattuple_12_1_pNo::Show(Long64_t entry)
{
...
Int_t makeclass_of_flattuple_12_1_pNo::Cut(Long64_t entry)
{
...
#endif // #ifdef makeclass_of_flattuple_12_1_pNo_cxx
