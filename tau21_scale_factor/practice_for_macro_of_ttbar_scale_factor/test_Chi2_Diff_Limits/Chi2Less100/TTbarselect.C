...
//  TreeReader data("flattuple_1.root");
  ...
  TH1D* h_reco_both_sides_lep_top_mass = new TH1D("h_reco_both_sides_lep_top_mass", " reco both sides lep top mass",100 , 0,1000 );
  TH1D* h_reco_both_sides_had_top_mass = new TH1D("h_reco_both_sides_had_top_mass", " reco both sides had top mass",100 , 0,1000 );
  ...
  TH1D* h_had_top_mass_signal = new TH1D("h_had_top_mass_signal", " had top mass signal",100 , 0,1000 );
  TH1D* h_had_top_mass_bk1 = new TH1D("h_had_top_mass_bk1", " had top mass bk1",100 , 0,1000 );
  TH1D* h_had_top_mass_bk2 = new TH1D("h_had_top_mass_bk2", " had top mass bk2",100 , 0,1000 );

  TH1D* h_lep_top_mass_signal = new TH1D("h_lep_top_mass_signal", " lep top mass signal",100 , 0,1000 );
  TH1D* h_lep_top_mass_bk1 = new TH1D("h_lep_top_mass_bk1", " lep top mass bk1",100 , 0,1000 );
  TH1D* h_lep_top_mass_bk2 = new TH1D("h_lep_top_mass_bk2", " lep top mass bk2",100 , 0,1000 );
...
//cout<<"chi2: "<< chi2<<" final_min_chi2: "<<final_min_chi2<<endl;
  ...
  if(final_min_chi2 < 100.0) // 3.0, 4.0, 10.0, 20.0, 50.0, 100.0, 500.0  no require 
