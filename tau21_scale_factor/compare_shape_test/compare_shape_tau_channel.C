...
void compare_shape_tau_channel(){
...
TFile  *f1 = new TFile("crab_TT1_semileptonic_ttbar_bk2_reversely_shape.root");
TFile  *f2 = new TFile("ttbar_signal_and_background_shape_normalize.root");

TH1D *h_tau_channel_signal = (TH1D*)f1->Get("h_had_top_mass_signal");
TH1D *h_tau_channel_bk1 = (TH1D*)f1->Get("h_had_top_mass_bk1");




TH1D *h_Bkg2_from_all_ttbar_sample = (TH1D*)f1->Get("h_had_top_mass_bk2");
TH1D *h_Bkg2_from_semileptonic_sample = (TH1D*)f2->Get("h_had_top_mass_bk2");

// normalize h_Bkg2_from_all_ttbar_sample
h_Bkg2_from_all_ttbar_sample-> Sumw2();
double scale = 1.0/( h_Bkg2_from_all_ttbar_sample->Integral() );
h_Bkg2_from_all_ttbar_sample->Scale(scale);

// draw 

TCanvas* c1 = new TCanvas("c1","",500,500);

h_Bkg2_from_all_ttbar_sample->SetLineColor(2);
h_Bkg2_from_all_ttbar_sample->GetXaxis()->SetRangeUser(100, 600);
h_Bkg2_from_all_ttbar_sample->Draw();

TH1D *h_Bkg2_from_all_ttbar_sample_fill = (TH1D*)h_Bkg2_from_all_ttbar_sample->Clone("h_Bkg2_from_all_ttbar_sample");
h_Bkg2_from_all_ttbar_sample_fill-> Sumw2(false);
h_Bkg2_from_all_ttbar_sample_fill->SetFillStyle(1001);
h_Bkg2_from_all_ttbar_sample_fill->SetFillColorAlpha(2,0.2);
h_Bkg2_from_all_ttbar_sample_fill->Draw("same");

h_Bkg2_from_semileptonic_sample->SetLineColor(4);
h_Bkg2_from_semileptonic_sample->Draw("same");

TH1D *h_Bkg2_from_semileptonic_sample_fill = (TH1D*)h_Bkg2_from_semileptonic_sample->Clone("h_Bkg2_from_semileptonic_sample");
h_Bkg2_from_semileptonic_sample_fill-> Sumw2(false);
h_Bkg2_from_semileptonic_sample_fill->SetFillStyle(1001);
h_Bkg2_from_semileptonic_sample_fill->SetFillColorAlpha(4,0.2);
h_Bkg2_from_semileptonic_sample_fill->Draw("same");
