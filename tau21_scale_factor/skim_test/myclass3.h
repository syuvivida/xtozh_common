...
// Sun Jan 25 17:53:16 2015 by ROOT version 5.34/21
...
#ifdef myclass3_cxx
myclass3::myclass3(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("flattuple_3169.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("flattuple_3169.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("flattuple_3169.root:/tree");
...
Int_t myclass3::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t myclass3::LoadTree(Long64_t entry)
{
...
void myclass3::Show(Long64_t entry)
{
...
Int_t myclass3::Cut(Long64_t entry)
{
