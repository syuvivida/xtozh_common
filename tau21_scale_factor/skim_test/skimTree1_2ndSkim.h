...
// Sun Jan 25 16:47:11 2015 by ROOT version 5.34/21
// from TTree tree/tree
// found on file: flattuple_3169.root
//////////////////////////////////////////////////////////

#ifndef skimTree1_2ndSkim_h
#define skimTree1_2ndSkim_h
...
//   TBranch        *b_CA8subjetMotherIndex;   //!
   ...
   skimTree1_2ndSkim(std::string inputFile,TTree *tree=0);
   virtual ~skimTree1_2ndSkim();
...
#ifdef skimTree1_2ndSkim_cxx

//std::string inputFile = "/Users/index0192/skim_test/flattuple_3169.root";
//skimTree1::skimTree1(std::string inputFile,TTree *tree) : fChain(0)
skimTree1_2ndSkim::skimTree1_2ndSkim(std::string inputFile,TTree *tree) : fChain(0) 
{
...
skimTree1_2ndSkim::~skimTree1_2ndSkim()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t skimTree1_2ndSkim::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t skimTree1_2ndSkim::LoadTree(Long64_t entry)
{
...
void skimTree1_2ndSkim::Init(TTree *tree)
{
...
//   fChain->SetBranchAddress("muSimplePt", &muSimplePt, &b_muSimplePt);
...
Bool_t skimTree1_2ndSkim::Notify()
{
...
void skimTree1_2ndSkim::Show(Long64_t entry)
{
...
#endif // #ifdef skimTree1_2ndSkim_cxx
