...
// Thu Mar  5 19:39:25 2015 by ROOT version 5.34/21
// from TTree tree/tree
// found on file: flattuple_94_filtered.root
//////////////////////////////////////////////////////////

#ifndef flattuple_94_h
#define flattuple_94_h
...
public :
   ...
   flattuple_94(TTree *tree=0);
   virtual ~flattuple_94();
...
#ifdef flattuple_94_cxx
flattuple_94::flattuple_94(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("flattuple_94_filtered.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("flattuple_94_filtered.root");
      }
...
flattuple_94::~flattuple_94()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t flattuple_94::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t flattuple_94::LoadTree(Long64_t entry)
{
...
void flattuple_94::Init(TTree *tree)
{
...
void flattuple_94::Show(Long64_t entry)
{
...
Int_t flattuple_94::Cut(Long64_t entry)
{
