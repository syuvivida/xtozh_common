...
int N_times = 10000;//1000   // how many things to fluctuate 

int save_pseudo_data_flag = 0; // save pseudo-data in ROOT file
int save_flag = 1; // save the pull and fit-bias in ROOT file

int sample_flag=3; // choose which sample

//
//TFile *f1 ;
char filename_[200];

     if (sample_flag == 0){char filename[200]={"shape_Chi2Less4_BinWidth5.root"}; strcpy(filename_, filename); }
else if (sample_flag == 1){char filename[200]={"shape_Chi2Less4_BinWidth1.root"}; strcpy(filename_, filename); }
else if (sample_flag == 2){char filename[200]={"shape_Chi2Less20_BinWidth5.root"}; strcpy(filename_, filename); }
else if (sample_flag == 3){char filename[200]={"shape_Chi2Less20_BinWidth1.root"}; strcpy(filename_, filename); }
...
double Frc1[4]={0.374,0.374,0.341,0.341};
int NumberData[4]={536,536,791,791};
