...
//                                 original, relax chi2-sorting, relax chi2-sorting + chi2<4.0
double fraction_1= 0.10;//         0.56      0.28                0.342
int NumberOfEventOfData = 536;//  686       1047                536 
...
{
TFile  *myFile = new TFile("ChangeClassify_RelaxChi2hadW_shape_pseudodata.root","recreate");
